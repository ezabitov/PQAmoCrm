let
getLeads = (limitOff as text, url as text, authQuery as record) =>
    let
...
*/
        ...
        getFnToTable = Table.AddColumn(numberToText, "Custom", each mainQuery([Column1]))
in
    getFnToTable
in
getFn
